...
public class sendRoleMessage extends ListenerAdapter {
    ...
    static Emoji resetEmoji = Emoji.fromUnicode("U+1F504");
    @Override
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        if(event.getInteraction().getName().equals("sendrolemessage")){
            ...
            textChannel.sendMessage("**Wybierz swoj\u0105 klas\u0119!**\n" +
                    ...
                    "<@&1141379724183085076>: " + warlockEmoji.getFormatted())
                    .addActionRow(selectClass).addActionRow(Button.primary("reset", resetEmoji).withLabel("Reset")).queue();
        }
    }
}
